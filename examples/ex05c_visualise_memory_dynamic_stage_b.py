...
parser.add_argument("--threshold", help="Visualisation threshold", required=False, default=1.0e-6, type=float)
args = parser.parse_args()

# Load memory state
data = torch.load(f"{script_dir}/data/ex05/05c_stage_b_dynamics_memory_state.datarec.pt")
